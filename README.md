...
Matching as close as possible to the designated route in a url.

1. How would you explain form validation to someone who has never programmed before?

It's when you fill out a form and you make sure everything required is input into the correct fields.

1. In 1-2 sentences, define end to end testing.

simulating user experience to make sure everything works as intended
